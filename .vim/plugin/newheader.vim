...
"    press F6 (change the mapping if you like).
...
nmap <F6> :call CreateFunctionHeader()<CR>
if has("menu")
  amenu &Local.&Function\ Header<Tab><F6>   <F6>
endif
...
" Place the cursor one or more lines before the function and press F6. It
" gives you:
"
" /****************************************************************************
"  *
